        ...
        <div className="bg-gray-50 rounded-[3rem] p-10 md:p-16 relative overflow-hidden border border-gray-200 shadow-sm">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
              <a href="https://github.com/suryaNarayanaa/Myrva" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-gray-900 text-sm font-medium transition-colors group">
